...
export default function Dummy2() {
  ...
  function Screen1() {
    ...
    return <Card style={{ width: '700px', height: '850px', borderColor: '#E5E5E5', margin: 'auto' }}>
      <Card.Body>
        ...
        <Form>
          ...
          <Form.Group controlId="formBasicUserID">
            ...
            <Form.Control type="userID" placeholder="User ID" defaultValue={userName} onChange={e => setUserName(e.target.value)} />
          </Form.Group>

          <Form.Group controlId="formBasicPassword">
            <Form.Label>Password</Form.Label>
            <Form.Control type="password" placeholder="Password" defaultValue={userTitle} onChange={e => setUserTitle(e.target.value)} />
          </Form.Group>

          <Form.Group controlId="formBasicPassword2">
            <Form.Label>Confirm Password</Form.Label>
            <Form.Control type="password" placeholder="confirm password" defaultValue={userPassword} onChange={e => setUserPasword(e.target.value)} />
          </Form.Group>
        </Form>
